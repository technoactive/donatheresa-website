      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          ...
          <div className="relative">
            ...
            <span className="absolute inset-0 rounded-full bg-gradient-to-r from-amber-500 to-yellow-400 animate-pulse" />
            <Button
              asChild
              className="group relative px-6 py-2.5 bg-gradient-to-r from-amber-600 to-yellow-500 hover:from-amber-500 hover:to-yellow-400 text-white rounded-full text-sm font-medium border-0 overflow-hidden transition-all duration-300 hover:scale-105 shadow-xl shadow-amber-500/50"
            >
            ...
            >
              ...
              <nav className="flex flex-col gap-3 p-6">
                ...
                <div className="mt-8 relative">
                  {/* Animated ping ring effect */}
                  <span className="absolute inset-0 rounded-xl bg-amber-400 animate-ping opacity-75" />
                  <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-400 animate-pulse" />
                  <Button
                    asChild
                    className="relative w-full py-6 bg-gradient-to-r from-amber-600 to-yellow-500 hover:from-amber-500 hover:to-yellow-400 text-white rounded-xl text-xl font-semibold transition-all duration-300 hover:scale-105 shadow-xl shadow-amber-500/50"
                  >
