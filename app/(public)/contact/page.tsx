  ...
  return (
    <div className="bg-gradient-to-b from-slate-50 to-white min-h-screen">
      ...
      <section className="relative overflow-hidden pt-20 pb-10 md:pb-16">
        {/* Background Pattern */}
        <div className="absolute inset-0 bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 opacity-50"></div>
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_20%,_rgba(251,191,36,0.1)_0%,_transparent_50%)]"></div>
          <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_70%_80%,_rgba(249,115,22,0.08)_0%,_transparent_50%)]"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <div className="flex justify-center">
              <Badge variant="outline" className="bg-white/80 backdrop-blur-sm border-amber-200 text-amber-700 px-6 py-2 text-sm font-medium">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-amber-600 to-orange-500 hover:from-amber-500 hover:to-orange-400 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-6 text-lg"
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-amber-200 text-amber-700 hover:bg-amber-50 px-8 py-6 text-lg"
                asChild
              >
                <Link href="/reserve">
      ...
      <section className="py-6 bg-white/50 backdrop-blur-sm border-y border-slate-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex items-center justify-center space-x-3">
              ...
              <div className="text-left">
                ...
                <RestaurantPhoneLink className="text-slate-900 font-semibold hover:text-amber-600 transition-colors">
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <div className="text-left">
                <p className="text-sm font-medium text-slate-600">Open Hours</p>
                <p className="text-slate-900 font-semibold">Tue-Sun 12:00-23:00</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="contact-form" className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="shadow-2xl border-0 overflow-hidden">
            <div className="bg-gradient-to-r from-amber-600 to-orange-500 p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="h-12 text-base border-slate-300 focus:border-amber-500 focus:ring-amber-500 transition-all duration-200"
                          required
                        />
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={handleSelectChange} required>
                        <SelectTrigger className="h-12 text-base border-slate-300 focus:border-amber-500 focus:ring-amber-500 transition-all duration-200">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="min-h-[120px] text-base border-slate-300 focus:border-amber-500 focus:ring-amber-500 transition-all duration-200 resize-none"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <Button
                      ...
                      className="w-full h-14 bg-gradient-to-r from-amber-600 to-orange-500 hover:from-amber-500 hover:to-orange-400 text-white text-lg font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100"
                    >
                      {isSubmitting ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                      <Button
                        ...
                        variant="outline"
                        size="lg"
                        className="border-amber-300 text-amber-700 hover:bg-amber-50 px-8 py-6"
                      >
                      ...
                      <Button
                        size="lg"
                        className="bg-gradient-to-r from-amber-600 to-orange-500 hover:from-amber-500 hover:to-orange-400 text-white px-8 py-6"
                        asChild
                      >
                        <Link href="/reserve">
                          <Calendar className="w-5 h-5 mr-2" />
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <Badge variant="outline" className="bg-white border-amber-200 text-amber-700 mb-4">
              Contact Information
            </Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg overflow-hidden">
              <div className="bg-gradient-to-br from-amber-500 to-orange-500 p-6">
            ...
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg overflow-hidden">
              <div className="bg-gradient-to-br from-blue-500 to-purple-500 p-6">
                ...
                <p className="text-blue-100">Immediate assistance available</p>
              </div>
              <CardContent className="p-6">
                <div className="space-y-3">
                  <div>
                    <p className="font-semibold text-slate-900">
                      <RestaurantPhoneLink className="hover:text-blue-600 transition-colors">
                        <RestaurantInfo type="phone" fallback="020 8421 5550" />
                      </RestaurantPhoneLink>
                    </p>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg overflow-hidden">
              <div className="bg-gradient-to-br from-green-500 to-teal-500 p-6">
                ...
                <p className="text-green-100">Tuesday to Sunday</p>
              </div>
              <CardContent className="p-6">
                <div className="space-y-3">
                  <div>
                    <p className="font-semibold text-slate-900">Lunch: 12:00 - 15:00</p>
                    <p className="font-semibold text-slate-900">Dinner: 18:00 - 23:00</p>
