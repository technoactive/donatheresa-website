...
const menuCategories = [
  ...
  },
  {
    ...
    description: "Celebrate the season with our specially crafted Christmas menu featuring traditional favorites with an Italian twist",
    image: "https://images.unsplash.com/photo-1481391319762-47dff72954d9?w=800&h=600&fit=crop&crop=center",
    icon: Sparkles,
    highlight: "Festive Special",
    link: "/menu/christmas-menu",
    gradient: "from-red-500 to-green-600",
    bgGradient: "from-red-50 to-green-50",
  },
  {
    id: "december-christmas-menu",
    title: "December Christmas Menu",
    subtitle: "Holiday delights",
    description: "Extended festive menu throughout December featuring seasonal specialties and celebratory dishes",
