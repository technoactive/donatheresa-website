...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'restaurants watford',
    'best restaurants watford',
    'restaurants near watford',
    'italian food watford',
    'best italian watford',
    'watford dining',
    'italian watford',
    'places to eat watford',
    'restaurants watford town'
  ],
  openGraph: {
  ...
  const features = [
    {
      icon: Award,
      title: "Award-Winning",
      description: "Consistently rated among the best Italian restaurants near Watford"
    },
    {
      icon: Utensils,
    ...
    },
    {
      ...
      description: "Business dinners, celebrations, family gatherings"
    }
  ]
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              ...
              <span className="text-amber-600">Italian Restaurant Near Watford</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-700 max-w-3xl mx-auto">
              Searching for an exceptional Italian restaurant near Watford? Dona Theresa is just 20 minutes away 
      ...
      <section className="py-16 bg-white border-y">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-3xl md:text-4xl font-bold text-amber-600 mb-2">20 min</div>
              <p className="text-slate-600">From Watford</p>
            </div>
            <div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            Why Choose Dona Theresa for Italian Dining Near Watford
          </h2>
          <p className="text-xl text-slate-600 text-center mb-12 max-w-3xl mx-auto">
            Just a short drive from Watford, we offer authentic Italian excellence 
            with sophisticated atmosphere and award-winning service
          </p>
      ...
      <section className="py-20 bg-gradient-to-b from-amber-50 to-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            Why Watford Residents Choose Dona Theresa
          </h2>
          
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div>
              <h3 className="text-2xl font-semibold mb-6">Worth the 20-Minute Journey</h3>
              <div className="space-y-4">
                <p className="flex items-start gap-3">
                  <MapPin className="w-6 h-6 text-amber-600 mt-1" />
                  <span>
                    <strong>Easy access from Watford</strong><br />
                    Via A412 or A4180, convenient location
                  </span>
                </p>
                <p className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Award-winning excellence beyond what Watford offers
                  </span>
                </p>
                <p className="flex items-start gap-3">
                  <Users className="w-6 h-6 text-amber-600 mt-1" />
                  <span>
                    <strong>Popular destination</strong><br />
                    Regularly chosen by Watford residents for special occasions
                  </span>
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <p className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Between Pinner & Hatch End, close to Watford
                  </span>
                </p>
                <p className="flex items-start gap-3">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-slate-50 rounded-2xl p-8">
              ...
              <p className="text-slate-700 mb-4">
                "20 minutes from Watford and absolutely worth it! This is the best Italian restaurant near me. Authentic food, perfect service, amazing atmosphere."
              </p>
              <p className="font-semibold">Karen B.</p>
              <p className="text-sm text-slate-600">From Watford</p>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-8">
              ...
              <p className="text-slate-700 mb-4">
                "Colleagues from Watford joined us and they're now regular visitors. They say it's definitely the best Italian restaurant near Watford, worth every minute of the drive."
              </p>
              <p className="font-semibold">Martin S.</p>
            ...
            <div className="bg-slate-50 rounded-2xl p-8">
              ...
              <p className="text-slate-700 mb-4">
                "Celebrated our anniversary here. The short drive from Watford felt like a special journey. Exceptional food and unforgettable evening. Highly recommend!"
              </p>
              <p className="font-semibold">Susan & Tom</p>
              <p className="text-sm text-slate-600">Watford Residents</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-slate-700 mb-6">
                Great value lunch option for Watford visitors. Choose from our 
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-slate-700 mb-6">
                Unlike most Watford restaurants, we offer FREE customer parking on-site 
                - making your visit convenient and hassle-free.
              </p>
              <ul className="space-y-2 text-slate-700 mb-6">
                <li>• Dedicated customer parking</li>
                <li>• No parking charges or meters</li>
      ...
      <section className="py-20 bg-gradient-to-b from-amber-50 to-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Experience the Best Italian Restaurant Near Watford?
          </h2>
          <p className="text-xl text-slate-700 mb-8">
            Just 20 minutes from Watford, Dona Theresa delivers authentic Italian excellence 
