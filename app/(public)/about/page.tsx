...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_GB",
    url: "https://www.donatheresa.com/about",
    siteName: "Dona Theresa",
    images: [
      {
        url: "https://www.donatheresa.com/og-about.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://www.donatheresa.com/og-about.jpg"]
  },
  alternates: {
    canonical: "https://www.donatheresa.com/about"
  }
}
...
export default function AboutPage() {
  const jsonLd = {
    ...
    "priceRange": "££",
    "image": "https://www.donatheresa.com/restaurant-image.jpg",
