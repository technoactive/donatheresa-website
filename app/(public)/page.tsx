...
export default function HomePage() {
  return (
    <>
      ...
      {/* Google Reviews Section - Editorial Magazine Design */}
      <section className="py-24 md:py-32 relative overflow-hidden" aria-labelledby="reviews-heading">
        {/* Warm Cream Background with Texture */}
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-radial from-amber-100/40 to-transparent rounded-full" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="text-center mb-16 md:mb-24">
            <div className="inline-flex items-center gap-4 mb-6">
              ...
              <div className="h-[1px] w-12 md:w-20 bg-gradient-to-l from-transparent to-amber-600" />
            </div>
            
            <h2 id="reviews-heading" className="text-4xl md:text-6xl lg:text-7xl font-serif mb-6 tracking-tight text-stone-900">
              What Our{' '}
            ...
            {/* Google Rating Badge - Refined */}
            <div className="inline-flex items-center gap-3 mt-6 px-5 py-2.5 bg-white/80 backdrop-blur-sm rounded-full border border-amber-200/50 shadow-sm">
              ...
              <span className="text-stone-600 text-sm font-medium">4.9 rating on Google</span>
            </div>
          </div>

          {/* Featured Review - Hero Style */}
          <div className="mb-12 md:mb-16">
            <div className="relative bg-white rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 lg:p-16 shadow-[0_20px_80px_-20px_rgba(180,140,80,0.3)] border border-amber-100/50 overflow-hidden group">
              {/* Decorative Quote Mark */}
              <div className="absolute -top-4 -left-4 md:top-0 md:left-0">
                <Quote className="w-24 h-24 md:w-40 md:h-40 text-amber-100 transform -rotate-12" />
              </div>
              
              {/* Decorative Corner Accent */}
              <div className="absolute top-0 right-0 w-32 h-32 md:w-48 md:h-48">
                <div className="absolute top-4 right-4 w-full h-full border-t-2 border-r-2 border-amber-200/50 rounded-tr-3xl" />
              </div>
              
              <div className="relative z-10 max-w-4xl mx-auto text-center">
                <div className="flex items-center justify-center gap-1 mb-6 md:mb-8">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 md:w-6 md:h-6 fill-amber-500 text-amber-500" />
                  ))}
                </div>
          ...
          {/* Featured On Platforms - Elegant Redesign */}
          <div className="mt-20 md:mt-28">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-4">
                <div className="h-[1px] w-16 bg-gradient-to-r from-transparent to-amber-400/50" />
                <span className="text-xs tracking-[0.3em] text-stone-500 uppercase font-medium">Featured On</span>
                <div className="h-[1px] w-16 bg-gradient-to-l from-transparent to-amber-400/50" />
              </div>
            </div>
            
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-8 border border-amber-100/50 shadow-sm">
              <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 lg:gap-8">
                ...
                <Link 
                  ...
                  className="group flex flex-col items-center gap-2 px-4 py-3 rounded-xl hover:bg-amber-50 transition-all"
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">Google</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">TripAdvisor</span>
                  </div>
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                ...
                {/* Facebook */}
                <Link 
                  href="https://www.facebook.com/profile.php?id=100063506503168"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center gap-2 px-4 py-3 rounded-xl hover:bg-amber-50 transition-all"
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">Facebook</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">Yelp</span>
                  </div>
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-2.5 h-2.5 fill-[#FF1A1A] text-[#FF1A1A]" />
                    ))}
                  </div>
                </Link>
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 bg-gradient-to-br from-orange-500 to-red-500 rounded flex items-center justify-center">
                      <Utensils className="w-3 h-3 text-white" />
                    </div>
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">Restaurant Guru</span>
                  </div>
                  <span className="text-stone-400 text-xs">Top Rated</span>
                </Link>
                ...
                >
                  <div className="flex items-center gap-2">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#00A86B">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/>
                    </svg>
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">TheFork</span>
                  </div>
                  <div className="flex items-center gap-1">
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 bg-[#FFD200] rounded flex items-center justify-center">
                      <span className="text-black font-black text-[10px]">Y</span>
                    </div>
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">Yell</span>
                  </div>
                  <span className="text-stone-400 text-xs">Business Directory</span>
                </Link>
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="w-5 h-5 bg-[#005BBB] rounded-full flex items-center justify-center">
                      <span className="text-white font-bold text-[10px]">M</span>
                    </div>
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">ViaMichelin</span>
                  </div>
                  <div className="flex items-center gap-1">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-stone-600 font-medium text-sm group-hover:text-stone-900 transition-colors">Table Agent</span>
                  </div>
                  <span className="text-stone-400 text-xs">Book Online</span>
                </Link>
              </div>
            </div>
          </div>
