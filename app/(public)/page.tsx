            ...
            <div className="flex flex-wrap justify-center items-center gap-6 lg:gap-10">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/70 font-medium group-hover:text-white transition-colors">Google</span>
                </div>
                <div className="flex items-center gap-1">
                  {[...Array(5)].map((_, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/70 font-medium group-hover:text-white transition-colors">TripAdvisor</span>
                </div>
                <div className="flex items-center gap-1">
                  {[...Array(5)].map((_, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/70 font-medium group-hover:text-white transition-colors">Facebook</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/70 font-medium group-hover:text-white transition-colors">Yelp</span>
                </div>
                <div className="flex items-center gap-1">
                  {[...Array(5)].map((_, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/70 font-medium group-hover:text-white transition-colors">Restaurant Guru</span>
                </div>
              ...
              >
                <div className="flex items-center gap-2">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="#00A86B">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/>
                  </svg>
                  <span className="text-white/70 font-medium group-hover:text-white transition-colors">TheFork</span>
                </div>
                <div className="flex items-center gap-1">
